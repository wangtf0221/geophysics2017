...
In elastic case, due to the complex wave phenomenons, the four wavefields in eq.
...
\subsection{Stage \uppercase\expandafter{\romannumeral1}: ERTI of PP reflection}
...
\subsection{Stage \uppercase\expandafter{\romannumeral2}: ERTI of PS reflection}
...
Therefore, we recommend to use method {\bf\uppercase\expandafter{\romannumeral2}}.
...
method {\bf\uppercase\expandafter{\romannumeral2}}, even if $\delta V_p$ is obtained by the
least-squares ERTM. 
...
\begin{figure}[!htb]
   \centering
   \subfloat{\includegraphics[width=0.5\textwidth]{sigbee2_new/Fig/Truevp.pdf}}
   \subfloat{\includegraphics[width=0.5\textwidth]{sigbee2_new/Fig/Truevs.pdf}}\\
   \subfloat{\includegraphics[width=0.5\textwidth]{sigbee2_new/Fig/Initvp.pdf}}
   \subfloat{\includegraphics[width=0.5\textwidth]{sigbee2_new/Fig/Initvs.pdf}}
...
\begin{figure}[!htb]
   \centering
   \subfloat[]{\includegraphics[width=0.5\textwidth]{sigbee2_new/Fig/imageInitialvp.pdf}}
   \subfloat[]{\includegraphics[width=0.5\textwidth]{sigbee2_new/Fig/imageInitialvs.pdf}}\\
   \subfloat[]{\includegraphics[width=0.5\textwidth]{sigbee2_new/Fig/Initvp.pdf}}
   \subfloat[]{\includegraphics[width=0.5\textwidth]{sigbee2_new/Fig/Initvs.pdf}}\\
...
\begin{figure}[!htb]
   \centering
   \subfloat[]{\includegraphics[width=0.5\textwidth]{sigbee2_new/Fig/RTIvp.pdf}}
   \subfloat[]{\includegraphics[width=0.5\textwidth]{sigbee2_new/Fig/RTIvs.pdf}}\\
   \caption{Inverted results of ERTI: (a) $V_p$, (b) $V_s$.}
   \label{fig:InvertedModel_ERTI}
\end{figure}
\begin{figure}[!htb]
   \centering
   \subfloat[]{\includegraphics[width=0.5\textwidth]{sigbee2_new/Fig/imageTRUEvp.pdf}}
   \subfloat[]{\includegraphics[width=0.5\textwidth]{sigbee2_new/Fig/imageTRUEvs.pdf}}\\
   \subfloat[]{\includegraphics[width=0.5\textwidth]{sigbee2_new/Fig/imageRTIvp.pdf}}
   \subfloat[]{\includegraphics[width=0.5\textwidth]{sigbee2_new/Fig/imageRTIvs.pdf}}
...
\begin{figure}[!htb]
   \centering
   \subfloat[]{\includegraphics[width=0.5\textwidth]{sigbee2_new/Fig/EFWI_RTIvp.pdf}}
   \subfloat[]{\includegraphics[width=0.5\textwidth]{sigbee2_new/Fig/EFWI_RTIvs.pdf}}
   \caption{
...
\begin{figure}[!htb]
   \centering
   \subfloat[]{\includegraphics[width=0.5\textwidth]{sigbee2_new/Fig/1_5km.pdf}}
   \subfloat[]{\includegraphics[width=0.5\textwidth]{sigbee2_new/Fig/3km.pdf}}
   \caption{
...
\begin{figure}[!thb]
   \centering
   \subfloat[]{\includegraphics[width=0.5\textwidth]{sigbee2_new/Fig/Cut3Hzvp.pdf}}
   \subfloat[]{\includegraphics[width=0.5\textwidth]{sigbee2_new/Fig/Cut3Hzvs.pdf}}\\
   \subfloat[]{\includegraphics[width=0.5\textwidth]{sigbee2_new/Fig/Cut5Hzvp.pdf}}
   \subfloat[]{\includegraphics[width=0.5\textwidth]{sigbee2_new/Fig/Cut5Hzvs.pdf}}\\
   \subfloat[]{\includegraphics[width=0.5\textwidth]{sigbee2_new/Fig/Cut7Hzvp.pdf}}
   \subfloat[]{\includegraphics[width=0.5\textwidth]{sigbee2_new/Fig/Cut7Hzvs.pdf}}\\
...
\section{Appendix B: further decomposition of $V_s$ kernel}
...
{\bf\uppercase\expandafter{\romannumeral1}} and {\bf\uppercase\expandafter{\romannumeral2}} when
predicting the PS reflection.
A single reflector example is adopted to show the damaging sensitivity of method
{\bf\uppercase\expandafter{\romannumeral1}} for inversion through 
...
Figure \ref{fig:PS_refl} shows the asymmetric ray path of PS reflection.
